...
\bigskip
{\problem[20 pts] \em Find the absolute minimum value of the function
$f(x,y)=x^2-2xy+2y$ on the rectangle $D=\big\{ (x,y) : 0\leq x \leq 3,
0 \leq y \leq 2 \big\}$.}
\vspace{18.5cm}
\begin{flushright}
  \begin{tikzpicture}
    \draw (-0.7cm,1.9cm) node {max:};
    \draw (0cm,1.4cm) rectangle (5cm,2.8cm);
    \draw (-0.7cm,0.5cm) node {min:};
    \draw (0cm,-0.2cm) rectangle (5cm,1.2cm);
  \end{tikzpicture}
\end{flushright}
\end{document}
