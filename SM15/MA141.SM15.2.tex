...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Page 1
\noindent{\large\bf MATH 141}\hfill{\large\bf Exam\#2.}\hfill{\large\bf
  Summer E 2015}\hfill{\large\bf Page 2/5}\hrule
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Page 2
\noindent{\large\bf MATH 141}\hfill{\large\bf Exam\#2.}\hfill{\large\bf
  Summer E 2015}\hfill{\large\bf Page 3/5}\hrule
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Page 3
\noindent{\large\bf MATH 141}\hfill{\large\bf Exam\#2.}\hfill{\large\bf
  Summer E 2015}\hfill{\large\bf Page 4/5}\hrule
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Page 4
\noindent{\large\bf MATH 141}\hfill{\large\bf Exam\#2.}\hfill{\large\bf
  Summer E 2015}\hfill{\large\bf Page 5/5}\hrule

\bigskip
{\problem[20 pts] \em Compute $\tfrac{dy}{dx}$ if
$x^3+y^3=6xy$.  Find the tangent line to the curve at the
point $(3,3)$.
\vspace{18cm}
\begin{flushright}
  \begin{tikzpicture}
