...
\noindent{\large\bf MATH 142}\hfill{\large\bf Exam \#1.}\hfill{\large\bf
  Fall 2015}\hfill{\large\bf Page 1/6}\hrule
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Page 2
\noindent{\large\bf MATH 142}\hfill{\large\bf Exam \#1.}\hfill{\large\bf
  Fall 2015}\hfill{\large\bf Page 2/6}\hrule
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Page 3
\noindent{\large\bf MATH 142}\hfill{\large\bf Exam \#1.}\hfill{\large\bf
  Fall 2015}\hfill{\large\bf Page 3/6}\hrule
...
\end{flushright}
\hrule
{\problem[10 pts] \em Evaluate the integral $\displaystyle{\int \sin^2 x\, dx}$.}
\vspace{10cm}
\begin{flushright}
  \begin{tikzpicture}
    \draw (-1.25cm,0.5cm) node {$\displaystyle{\int \sin^2 x\, dx} = $};
    \draw (0cm,-0.2cm) rectangle (5cm,1.2cm);
  \end{tikzpicture}
\end{flushright}
\newpage
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Page 4
\noindent{\large\bf MATH 142}\hfill{\large\bf Exam \#1.}\hfill{\large\bf
  Fall 2015}\hfill{\large\bf Page 4/6}\hrule

\bigskip
{\problem[10 pts] \em Use the trigonometric substitution $x=a\sec \theta$ to evaluate the integral $\displaystyle{\int \frac{dx}{\sqrt{x^2-9}}}$.}
\vspace{18cm}
\begin{flushright}
  \begin{tikzpicture}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Page 5
\noindent{\large\bf MATH 142}\hfill{\large\bf Exam \#1.}\hfill{\large\bf
  Fall 2015}\hfill{\large\bf Page 5/6}\hrule
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Page 6
\noindent{\large\bf MATH 142}\hfill{\large\bf Exam \#1.}\hfill{\large\bf
  Fall 2015}\hfill{\large\bf Page 6/6}\hrule
