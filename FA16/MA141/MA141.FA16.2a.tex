...
\begin{flushright}
  \begin{tikzpicture}
    \draw (-9.25cm,0.9cm) node {$y'=$};
    \draw (-8.5cm,0cm) rectangle (5cm,1.8cm);
  \end{tikzpicture}
\end{flushright}
\end{problem}
\newpage
...
\end{flushright}
\hrule
{\problem[10 pts] $f(x)=2^x (x^2+3)^{20}$}
\vspace{2cm}
\begin{flushright}
  \begin{tikzpicture}
    \draw (-1.25cm,0.5cm) node {$ f'(x) =$};
...
\end{flushright}
\hrule
{\problem[10 pts] $f(x)=2^x (x^2+3)^{20} \ln x$}
\vspace{2cm}
\begin{flushright}
  \begin{tikzpicture}
    \draw (-1.25cm,0.5cm) node {$ f'(x) =$};
