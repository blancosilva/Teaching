...
\bigskip
{\problem[5 pts] \em Find $f(-3)$ and $f(\pi^2-1)$ for}
$f(x) = 
\begin{cases}
...
\begin{flushright}
  \begin{tikzpicture}
    \draw (-1.2cm,0.5cm) node {$f(\pi^2-1) =$};
...
\end{flushright}
\hrule
{\problem[10 pts] \em Find the domain and range of $f(x) = 2 + \sqrt{2x-1}$.}
\vspace{4cm}
\begin{flushright}
  \begin{tikzpicture}
    \draw (-1cm,0.5cm) node {range $=$};
    \draw (0cm,0cm) rectangle (5cm,1.2cm);
    \draw (-1cm,2cm) node {domain $=$};
    \draw (0cm,1.4cm) rectangle (5cm,2.6cm);
  \end{tikzpicture}
\end{flushright}
\hrule
...
\end{flushright}
\hrule
{\problem[5pts] \em Find the domain of the function $f(x) = \dfrac{x}{3-e^{2x}}$.}
\vspace{5cm}
\begin{flushright}
\begin{tikzpicture}
...
\bigskip
{\problem[40 pts] \em Compute the following limits:}
\vspace{1cm}

\noindent
\begin{tikzpicture}
\draw (4.4cm,16cm) node{
(a) $\displaystyle{\lim_{x\to -2} \sqrt{x^4 - 2x^2 + 8}} = \mbox{}$ };
\draw (6.8cm,15.4cm) rectangle (11cm,16.6cm);
\draw (4cm,14cm) node{
(b) $\displaystyle{\lim_{x \to 1} \frac{x^2-2x-8}{x^2-4}} = \mbox{}$ };
\draw (6cm,13.4cm) rectangle (11cm,14.6cm);
\draw (4cm, 9cm) node{
(c) $\displaystyle{\lim_{x \to 2} \frac{x^2-2x-8}{x^2-4}} =
\mbox{}$}; 
\draw (6.1cm, 8.4cm) rectangle (11.1cm, 9.6cm); 
\draw (4cm, 2cm) node{
(d) $\displaystyle{\lim_{x \to 0} \frac{\sqrt{x+4}-2}{2x}} = \mbox{}$}; 
