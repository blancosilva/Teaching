...
\begin{flushright}
  \begin{tikzpicture}
    \draw (-0.75cm,0.5cm) node {$\cos \theta = $};
    \draw (0cm,-0.2cm) rectangle (5cm,1.2cm);
  \end{tikzpicture}
\end{flushright}
\end{problem}
...
\begin{flushright}
  \begin{tikzpicture}
    ...
    \draw (-2.75cm,-1.5cm) node {$\cos \theta = $};
...
\begin{flushright}
  \begin{tikzpicture}
    \draw (-1cm,0.5cm) node {equation: };
    \draw (0cm,-0.2cm) rectangle (5cm,1.2cm);
  \end{tikzpicture}
\end{flushright}
\begin{flushright}
  \begin{tikzpicture}
    \draw (-1cm,0.5cm) node {velocity: };
    \draw (0cm,-0.2cm) rectangle (5cm,1.2cm);
  \end{tikzpicture}
\end{flushright}
\begin{flushright}
  \begin{tikzpicture}
    \draw (-1.35cm,0.5cm) node {acceleration: };
    \draw (0cm,-0.2cm) rectangle (5cm,1.2cm);
  \end{tikzpicture}
\end{flushright}
\end{problem}
