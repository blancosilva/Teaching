...
\begin{equation*}
\frac{p(\x_{n+1}) - p(\xstar)}{p(\x_n)- p(\xstar)} \leq \bigg( \frac{\lambda_d -\lambda_0}{\lambda_d + \lambda_0} \bigg)^2
\end{equation*}
\end{theorem}
\begin{proof}
...
\begin{align*}
\frac{p(\x_{n+1}) - p(\xstar)}{p(\x_n)- p(\xstar)} &= 1 - \frac{\norm{\v_n}^4}{ \quadratic{Q}(\v_n) \quadratic{(Q^{-1})}(\v_n) } \\
&\leq 1 - \frac{4\lambda_0 \lambda_d}{(\lambda_0 + \lambda_d)^2} = \bigg( \frac{\lambda_d - \lambda_0}{\lambda_d + \lambda_0} \bigg)^2 \qedhere
\end{align*}
