...
\begin{description}
	...
	\begin{align*}
	g_k(\x) &\leq  0 &(1\leq k \leq m) \\
	h_j(\x) &= 0     &(1\leq j \leq n)
	\end{align*}
\end{description}
...
\end{description}
The development of existence and characterization results for unconstrained optimization will be covered in chapter \ref{chapter:existenceCharacterization}.  The design of algorithms to track extrema will be covered in chapter \ref{chapter:nonlinearoptimization}.
