...
\begin{definition}\index{Newton-Raphson!iteration}\index{Newton-Raphson!method}\index{Newton-Raphson!}
...
\begin{figure}[ht!]
\includegraphics[width=0.55\linewidth]{badNewton.png}
...
\begin{figure}[ht!]
\includegraphics[width=0.55\linewidth]{loop.png}
...
\begin{equation}\label{equation:NewtonMethod}\index{Newton-Raphson!method}
