...
\subsection{Efficiency of Newton-Raphson's Method}\index{Newton-Raphson!error}
...
\begin{theorem}[Local Convergence for the Newton-Raphson Method]\label{theorem:LCNR}\index{Newton-Raphson!Local convergence for}\index{Theorem!Local Convergence for Newton-Raphson}
...
\begin{equation}\index{Newton-Raphson!method}\index{Newton-Raphson!recursive formula}\index{Newton-Raphson!iteration}
