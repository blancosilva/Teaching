...
The starting point of these notes is the concept of \emph{optimization} as developed in a course in Vector Calculus (see e.g.~\cite[Chapter~14]{finney2001thomas})
...
\begin{equation*}f(x)= \log (x^4-2x^2+2).
\end{equation*}
