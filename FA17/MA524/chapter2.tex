...
\begin{figure}[ht!]
\begin{tabular}{cc}
\includegraphics[width=0.48\linewidth]{convexSet1.png} &
\includegraphics[width=0.48\linewidth]{convexSet2.png}
\end{tabular}
\caption{Convex sets.}
