...
\mbox{}$}; 
\draw (6cm, 5.4cm) rectangle (11.1cm, 6.6cm); 
\end{tikzpicture}
...
\vspace{8cm}
\hrule
{\problem[15 pts] \em How many tangent lines to the curve $y=x/(x+2)$
  pass through the point $(1,2)$.}      

\noindent{\textbf{HINT:} You do not have to compute the equations of
  the lines}
\end{document}
