...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Page 3
\noindent{\large\bf MATH 142}\hfill{\large\bf Exam\#3.}\hfill{\large\bf
  Spring 2012}\hfill{\large\bf Page 3/6}\hrule
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Page 4
\noindent{\large\bf MATH 142}\hfill{\large\bf Exam\#3.}\hfill{\large\bf
  Spring 2012}\hfill{\large\bf Page 4/6}\hrule

\bigskip
{\problem[5 pts] \em Apply the \textbf{zero-limit test} (also known as
...
\vspace{2cm}
\hrule
{\problem[10 pts] \em Use the \textbf{integral test} to determine
  whether the series $\displaystyle{\sum_{n=1}^\infty \frac{1}{5n+2}}$
  converges.} 
\vspace{6.5cm}
\hrule
{\problem[10 pts] \em Use the \textbf{ratio test} to determine whether
  the series $\displaystyle{\sum_{n=1}^\infty \frac{4^n}{n^2}}$  
  converges.  If the test is inconclusive, then say so.} 
\newpage

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Page 5
\noindent{\large\bf MATH 142}\hfill{\large\bf Exam\#3.}\hfill{\large\bf
  Spring 2012}\hfill{\large\bf Page 5/6}\hrule
  
\bigskip

{\problem[10 pts] \em Use the \textbf{root test} to determine whether
  the series $\displaystyle{\sum_{n=1}^\infty \Big( \frac{3n+2}{2n-1}
    \Big)^n}$ converges.  If the test is inconclusive, then say so.} 
\vspace{9cm}
\hrule{\problem[10 pts] \em Classify the series
  $\displaystyle{\sum_{n=1}^\infty (-1)^n\, \frac{4n^2+1}{n^3+2}}$ as
  absolutely convergent, convergent or divergent.} 

\newpage

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Page 6
\noindent{\large\bf MATH 142}\hfill{\large\bf Exam\#3.}\hfill{\large\bf
  Spring 2012}\hfill{\large\bf Page 6/6}\hrule
{\problem[15 pts] \em Find the radius of convergence and interval of
