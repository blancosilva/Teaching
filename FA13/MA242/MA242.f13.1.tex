...
{\problem[10 pts] \em Write a differential equation of the form
  ...
  the slope of the graph of $g$ at the point $(x,y)$ is twice the sum of $x$ and $y$.}
\vspace{1.5cm}
...
\begin{equation*}
9\frac{dy}{dx} = \frac{1}{\sqrt{3x+4}}\qquad y(7)=-1
\end{equation*}
...
{\problem[20 pts] \em Find a general solution of the differential
  equation}
  \begin{equation*} 
  \big(x^3+\tfrac{y}{x}\big) + (y^2+\ln x) y' = 0
  \end{equation*}
\vspace{8.5cm}
\begin{flushright}
  \begin{tikzpicture}
